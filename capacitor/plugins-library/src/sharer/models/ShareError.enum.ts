export enum ShareError {
    ...
    DoAction = "DO_ACTION_ERROR",
    EmptyData = "EMPTY_DATA_ERROR",
    EmptyFilePath = "EMPTY_FILE_PATH_ERROR",
    FileConversion = "FILE_CONVERSION_ERROR",
    FileToUri = "FILE_TO_URI_ERROR",
    InvalidFileParam = "INVALID_FILE_PARAM_ERROR",
    InvalidPath = "INVALID_PATH_ERROR",
